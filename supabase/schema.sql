...
-- `bookings` DOES have a delete grant — the admin dashboard's "Cancelled
-- & Declined" panel (api/admin/content.js, action: delete-booking /
-- delete-cancelled-bookings) permanently deletes rows already restricted
-- to status IN ('cancelled', 'declined') by that same delete statement.
-- ---------------------------------------------------------------------
grant usage on schema public to service_role;

grant select, insert, delete on table public.bookings to service_role;
